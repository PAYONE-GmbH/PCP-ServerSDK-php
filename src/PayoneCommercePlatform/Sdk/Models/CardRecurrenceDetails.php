...
class CardRecurrenceDetails
{
    ...
    protected ?RecurringPaymentSequenceIndicator $recurringPaymentSequenceIndicator;

    public function __construct(
        ?RecurringPaymentSequenceIndicator $recurringPaymentSequenceIndicator = null
    ) {
        $this->recurringPaymentSequenceIndicator = $recurringPaymentSequenceIndicator;
    }

    // Getters and Setters
    public function getRecurringPaymentSequenceIndicator(): ?RecurringPaymentSequenceIndicator
    {
        return $this->recurringPaymentSequenceIndicator;
    }

    public function setRecurringPaymentSequenceIndicator(?RecurringPaymentSequenceIndicator $recurringPaymentSequenceIndicator): self
    {
        $this->recurringPaymentSequenceIndicator = $recurringPaymentSequenceIndicator;
        return $this;
    }
