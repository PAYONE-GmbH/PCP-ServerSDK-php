...
class CheckoutApiClient extends BaseApiClient
{
     ...
     */
    public function createCheckout($merchantId, $commerceCaseId, $createCheckoutRequest): CreateCheckoutResponse
    {
     ...
     */
    public function createCheckoutAsync($merchantId, $commerceCaseId, $createCheckoutRequest): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckoutAsync($merchantId, $commerceCaseId, $checkoutId): PromiseInterface
    {
        $request = $this->getCheckoutRequest($merchantId, $commerceCaseId, $checkoutId);
        $request = $this->requestHeaderGenerator->generateAdditionalRequestHeaders($request);
     ...
     * @return void
     */
    public function updateCheckout($merchantId, $commerceCaseId, $checkoutId, $patchCheckoutRequest): void
    {
