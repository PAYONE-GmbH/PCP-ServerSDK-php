...
/**
 * PaymentReferences Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentReferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentReferences';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['merchantReference']) && (mb_strlen($this->container['merchantReference']) > 20)) {
    ...
    public function setMerchantReference($merchantReference)
    {
        ...
        if ((mb_strlen($merchantReference) > 20)) {
            throw new \InvalidArgumentException('invalid length for $merchantReference when calling PaymentReferences., must be smaller than or equal to 20.');
        }
