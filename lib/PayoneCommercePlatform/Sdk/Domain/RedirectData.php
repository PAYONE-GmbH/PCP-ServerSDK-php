...
/**
 * RedirectData Class Doc Comment
 *
 * @category Class
 ...
 */
class RedirectData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RedirectData';
    ...
    */
     ...
     * Sets redirectURL
     *
     * @param string|null $redirectURL The URL that the customer should be redirected to. Be sure to redirect using the GET method
     *
     * @return self
     */
