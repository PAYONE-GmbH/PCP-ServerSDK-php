 ...
 */
class ApplePaymentDataTokenHeaderInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePaymentDataTokenHeaderInformation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('applicationData', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets transactionId
     *
     * @param string|null $transactionId A hexadecimal Transaction identifier identifier as a string.
     *
     * @return self
     */
     ...
     *
     * @param string|null $applicationData SHA–256 hash, hex encoded as a string. Hash of the applicationData property of the original PKPaymentRequest object.
     *
     * @return self
     */
    public function setApplicationData($applicationData)
    {
        if (is_null($applicationData)) {
            throw new \InvalidArgumentException('non-nullable applicationData cannot be null');
        }
