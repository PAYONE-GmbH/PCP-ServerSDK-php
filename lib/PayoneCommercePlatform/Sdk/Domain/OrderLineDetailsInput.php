...
/**
 * OrderLineDetailsInput Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderLineDetailsInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderLineDetailsInput';
    ...
    */
    ...
    public function setProductPrice($productPrice)
    {
        ...
        if (($productPrice > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $productPrice when calling OrderLineDetailsInput., must be smaller than or equal to 2147483647.');
        }
        if (($productPrice < 0)) {
            throw new \InvalidArgumentException('invalid value for $productPrice when calling OrderLineDetailsInput., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderLineDetailsInput., must be smaller than or equal to 9999.');
        }
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderLineDetailsInput., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxAmount($taxAmount)
    {
        ...
        if (($taxAmount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $taxAmount when calling OrderLineDetailsInput., must be smaller than or equal to 2147483647.');
        }
        if (($taxAmount < 0)) {
            throw new \InvalidArgumentException('invalid value for $taxAmount when calling OrderLineDetailsInput., must be bigger than or equal to 0.');
        }
    ...
    public function setProductUrl($productUrl)
    {
        ...
        if ((mb_strlen($productUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $productUrl when calling OrderLineDetailsInput., must be smaller than or equal to 2048.');
        }
    ...
    public function setProductImageUrl($productImageUrl)
    {
        ...
        if ((mb_strlen($productImageUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $productImageUrl when calling OrderLineDetailsInput., must be smaller than or equal to 2048.');
        }
    ...
    public function setProductCategoryPath($productCategoryPath)
    {
        ...
        if ((mb_strlen($productCategoryPath) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $productCategoryPath when calling OrderLineDetailsInput., must be smaller than or equal to 2048.');
        }
