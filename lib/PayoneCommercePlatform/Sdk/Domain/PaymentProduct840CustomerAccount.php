 ...
 */
class PaymentProduct840CustomerAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentProduct840CustomerAccount';
    ...
    */
     ...
     * Sets companyName
     *
     * @param string|null $companyName Name of the company in case the PayPal account is owned by a business
     *
     * @return self
     */
     ...
     * Sets firstName
     *
     * @param string|null $firstName First name of the PayPal account holder
     *
     * @return self
     */
     ...
     * Sets payerId
     *
     * @param string|null $payerId The unique identifier of a PayPal account and will never change in the life cycle of a PayPal account.
     *
     * @return self
     */
     ...
     * Sets surname
     *
     * @param string|null $surname Surname of the PayPal account holder
     *
     * @return self
     */
