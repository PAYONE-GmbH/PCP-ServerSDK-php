...
/**
 * CaptureOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class CaptureOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptureOutput';
    ...
    */
    ...
    public function setMerchantParameters($merchantParameters)
    {
        ...
        if ((mb_strlen($merchantParameters) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $merchantParameters when calling CaptureOutput., must be smaller than or equal to 1000.');
        }
     ...
     * Sets paymentMethod
     *
     * @param string|null $paymentMethod Payment method identifier used by our payment engine.
     *
     * @return self
     */
