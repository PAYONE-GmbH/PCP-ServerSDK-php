...
/**
 * PaymentProduct771SpecificOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentProduct771SpecificOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentProduct771SpecificOutput';
    ...
    {
        $this->setIfExists('mandateReference', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $mandateReference Unique reference fo a SEPA Mandate
     *
     * @return self
     */
    public function setMandateReference($mandateReference)
    {
        if (is_null($mandateReference)) {
            throw new \InvalidArgumentException('non-nullable mandateReference cannot be null');
        }
