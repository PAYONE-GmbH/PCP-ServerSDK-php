...
/**
 * ReturnInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class ReturnInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnInformation';
    ...
    protected static $openAPITypes = [
        'returnReason' => 'string',
        'items' => '\PayoneCommercePlatform\Sdk\Domain\CartItemInput[]'
    ];
    ...
    */
    ...
    public function setReturnReason($returnReason)
    {
        ...
        if ((mb_strlen($returnReason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $returnReason when calling ReturnInformation., must be smaller than or equal to 255.');
        }
     ...
     * Gets items
     *
     * @return \PayoneCommercePlatform\Sdk\Domain\CartItemInput[]|null
     */
     ...
     * Sets items
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\CartItemInput[]|null $items Items returned.
     *
     * @return self
     */
