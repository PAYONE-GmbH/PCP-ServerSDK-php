...
/**
 * PositiveAmountOfMoney Class Doc Comment
 *
 * @category Class
 ...
 */
class PositiveAmountOfMoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PositiveAmountOfMoney';
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount Amount in cents and always having 2 decimals
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PositiveAmountOfMoney., must be smaller than or equal to 999999999999.');
        }
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PositiveAmountOfMoney., must be bigger than or equal to 1.');
        }
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Three-letter ISO currency code representing the currency for the amount
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PositiveAmountOfMoney., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PositiveAmountOfMoney., must be bigger than or equal to 3.');
        }
