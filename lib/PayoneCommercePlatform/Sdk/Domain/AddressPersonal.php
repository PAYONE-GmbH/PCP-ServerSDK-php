...
/**
 * AddressPersonal Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressPersonal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressPersonal';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressPersonal., must be smaller than or equal to 2.');
        }
