...
/**
 * CreateCommerceCaseRequest Class Doc Comment
 *
 * @category Class
 * @package  PayoneCommercePlatform\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCommerceCaseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCommerceCaseRequest';
    ...
    protected static $openAPITypes = [
        ...
        'checkout' => '\PayoneCommercePlatform\Sdk\Domain\CreateCheckoutRequest'
    ];
    ...
    */
    ...
    public function setMerchantReference($merchantReference)
    {
        ...
        if ((mb_strlen($merchantReference) > 40)) {
            throw new \InvalidArgumentException('invalid length for $merchantReference when calling CreateCommerceCaseRequest., must be smaller than or equal to 40.');
        }
     ...
     * Gets checkout
     *
     * @return \PayoneCommercePlatform\Sdk\Domain\CreateCheckoutRequest|null
     */
     ...
     * Sets checkout
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\CreateCheckoutRequest|null $checkout checkout
     *
     * @return self
     */
