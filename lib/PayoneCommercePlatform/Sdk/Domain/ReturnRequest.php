...
class ReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'returnType' => '\PayoneCommercePlatform\Sdk\Domain\ReturnType',
        'returnReason' => 'string',
        'returnItems' => '\PayoneCommercePlatform\Sdk\Domain\ReturnItem[]'
    ];
    ...
    */
     ...
     * Gets returnType
     *
     * @return \PayoneCommercePlatform\Sdk\Domain\ReturnType|null
     */
     ...
     * Sets returnType
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\ReturnType|null $returnType returnType
     *
     * @return self
     */
    ...
    public function setReturnReason($returnReason)
    {
        ...
        if ((mb_strlen($returnReason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $returnReason when calling ReturnRequest., must be smaller than or equal to 255.');
        }
     ...
     * Gets returnItems
     *
     * @return \PayoneCommercePlatform\Sdk\Domain\ReturnItem[]|null
     */
     ...
     * Sets returnItems
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\ReturnItem[]|null $returnItems returnItems
     *
     * @return self
     */
