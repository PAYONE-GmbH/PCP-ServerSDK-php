...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Id of the item from the ShoppingCart. The id will be returned in the response from create Checkout request.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of the specific item. Must be greater than zero.  Note: Must not be all spaces or all zeros
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderItem., must be smaller than or equal to 9999.');
        }
        if (($quantity < 1)) {
