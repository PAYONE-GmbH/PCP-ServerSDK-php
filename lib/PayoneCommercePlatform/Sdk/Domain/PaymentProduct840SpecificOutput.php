...
/**
 * PaymentProduct840SpecificOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentProduct840SpecificOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentProduct840SpecificOutput';
    ...
    protected static $openAPITypes = [
        ...
        'customerAccount' => '\PayoneCommercePlatform\Sdk\Domain\PaymentProduct840CustomerAccount',
        'shippingAddress' => '\PayoneCommercePlatform\Sdk\Domain\Address'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customerAccount', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \PayoneCommercePlatform\Sdk\Domain\PaymentProduct840CustomerAccount|null
     */
     ...
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\PaymentProduct840CustomerAccount|null $customerAccount customerAccount
     *
     * @return self
     */
    public function setCustomerAccount($customerAccount)
    {
        if (is_null($customerAccount)) {
            throw new \InvalidArgumentException('non-nullable customerAccount cannot be null');
        }
     ...
     *
     * @param \PayoneCommercePlatform\Sdk\Domain\Address|null $shippingAddress shippingAddress
     *
     * @return self
     */
