 ...
 */
class CardPaymentMethodSpecificOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardPaymentMethodSpecificOutput';
    ...
    */
    ...
    public function setPaymentProductId($paymentProductId)
    {
        ...
        if (($paymentProductId > 99999)) {
            throw new \InvalidArgumentException('invalid value for $paymentProductId when calling CardPaymentMethodSpecificOutput., must be smaller than or equal to 99999.');
        }
        if (($paymentProductId < 0)) {
            throw new \InvalidArgumentException('invalid value for $paymentProductId when calling CardPaymentMethodSpecificOutput., must be bigger than or equal to 0.');
        }
