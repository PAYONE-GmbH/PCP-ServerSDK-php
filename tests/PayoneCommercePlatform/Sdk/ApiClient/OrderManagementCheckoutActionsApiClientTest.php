...
class OrderManagementCheckoutActionsApiClientTest extends TestCase
{
    ...
    public function testCreateOrderSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 201, body: OrderManagementCheckoutActionsApiClient::serializeJson($orderResponse)));
    ...
    public function testDeliverOrderSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: OrderManagementCheckoutActionsApiClient::serializeJson($deliverResponse)));
    ...
    public function testReturnOrderSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: OrderManagementCheckoutActionsApiClient::serializeJson($returnResponse)));
