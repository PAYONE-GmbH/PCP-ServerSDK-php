...
class PaymentExecutionApiClientTest extends TestCase
{
    ...
    public function testCancelPaymentExecutionSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 204, body: $this->paymentExecutionClient->serializeJson($cancelPaymentResponse)));
    ...
    public function testCancelPaymentExecutionUnsuccessful400(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 400, body: $this->paymentExecutionClient->serializeJson($errorReponse)));
    ...
    public function capturePaymentExecutionSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: $this->paymentExecutionClient->serializeJson($capturePaymentResponse)));
    ...
    public function testCompletePaymentSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: $this->paymentExecutionClient->serializeJson($completePaymentResponse)));
    ...
    public function testCreatePaymentSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: $this->paymentExecutionClient->serializeJson($createPaymentResponse)));
    ...
    public function testRefundPaymentSuccessful(): void
    {
        ...
        $this->httpClient->method('send')->willReturn(new Response(status: 200, body: $this->paymentExecutionClient->serializeJson($refundPaymentResponse)));
